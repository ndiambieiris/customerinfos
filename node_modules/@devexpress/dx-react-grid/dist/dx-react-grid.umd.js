    ...
    ***************************************************************************** */
    ...
    var VirtualTableLayoutBlock = /*#__PURE__*/ (function (_super) {
        ...
        VirtualTableLayoutBlock.prototype.render = function () {
            var _a = this.props, collapsedGrid = _a.collapsedGrid, Body = _a.bodyComponent, cellComponent = _a.cellComponent, rowComponent = _a.rowComponent, isFixed = _a.isFixed;
            return (React.createElement(Body, { isFixed: isFixed }, collapsedGrid.rows.map(function (visibleRow) {
                ...
                return (React.createElement(VirtualRowLayout, { key: row.key, row: row, cells: cells, rowComponent: rowComponent, cellComponent: cellComponent }));
            })));
        };
